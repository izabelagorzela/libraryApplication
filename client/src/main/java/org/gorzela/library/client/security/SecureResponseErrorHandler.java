...
public class SecureResponseErrorHandler implements ResponseErrorHandler {
   ...
   public void handleError(ClientHttpResponse response) throws IOException {
       ...
       if(code == HttpStatus.UNAUTHORIZED) {
           ...
           errorInformation.showInformation("Niepoprawne dane uwierzytelniające", "Podałeś błędne hasło bądź login");
           loginFormController.resetLoginTextFields();
       }
       if(code == HttpStatus.FORBIDDEN) {

           errorInformation.showInformation("Brak dostępu", "Nie masz uprawnień");
           loginFormController.resetLoginTextFields();
       }
    }
}
